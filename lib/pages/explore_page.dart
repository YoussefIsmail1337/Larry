  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FutureBuilder<List<Map<String, dynamic>>>(
                    future: NetworkHandler.getSuggestions(),
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        if (snapshot.data!.isNotEmpty) {
                          if (snapshot.data![0]['error'] == null) {
                            ...
                            Future.delayed(
                              ...
                              () => ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content: Text(snapshot.data![0]['error'])),
                              ),
                            );
                            return const Center(
                          ...
                          return const Center(
                            child: Text(
                              'No one in your suggested accounts.',
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 5),
                  child: FutureBuilder<List<Map<String, dynamic>>>(
                    future: NetworkHandler.getExplore(),
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        if (snapshot.data!.isNotEmpty) {
                          if (snapshot.data![0]['error'] == null) {
                                  ...
                                  children: [
                                    Tweet(
                                      ...
                                      embeddedtweetdeleted: snapshot
                                          .data![index]['embeddedtweetdeleted'],
                                      replies: snapshot.data![index]['replies'],
                                    ),
                                    const Padding(
                                      padding:
                          ...
                          return const Center(
                            child: Text(
                              'No lars in your explore.\n\nNo one has lared yet.',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, '/Post', arguments: {'retweetID': ''})
              .then((value) => setState(() {}));
        },
        child: const Icon(
          Icons.add,
